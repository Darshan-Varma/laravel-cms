...
<section class="w3-padding">
    ...
    <form method="post" action="/console/studies/edit/{{$study->id}}" novalidate class="w3-margin-bottom">
        ...
        <div class="w3-margin-bottom">
            ...
            <input type="text" name="school_name" id="school_name" value="{{old('school_name', $study->school_name)}}" required>
        ...
        <div class="w3-margin-bottom">
            ...
            <input type="text" name="education_level" id="education_level" value="{{old('education_level', $study->education_level)}}" required>
        ...
        <div class="w3-margin-bottom">
            ...
            <input type="date" name="start_at" id="start_at" value="{{old('start_at', $study->start_at)}}" required>
        ...
        <div class="w3-margin-bottom">
            ...
            <input type="date" name="end_at" id="end_at" value="{{old('end_at', $study->end_at)}}" required>
